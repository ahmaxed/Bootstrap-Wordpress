      ...
      <div class="row">
        ...
        <div id="mc_embed_signup">
          <form class="col-xs-10 col-xs-offset-1 col-sm-7 col-sm-offset-0 col-md-6 col-md-offset-0 col-lg-6 form-inline subscribe " role="form" action="//normanfinkelstein.us9.list-manage.com/subscribe/post?u=284edae059d93053e3ffcc14a&amp;id=320295a52d" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                ...
                <button type="submit" class="btn btn-sample  col-xs-12 col-sm-5 col-md-5" id="mc-embedded-subscribe" name="subscribe">
      ...
      <div class="row equal reading-field">
        ...
        <div class="col-md-3">
            ...
            <div class="col-xs-12 col-md-12 center">
              ...
              <p>
                <a   href="<?php the_permalink(); ?>">
                  ...
                  <!-- <?php echo $thumbnail_url[0]; ?> for echoing the related webpage-->
          ...
          <div class="center col-md-12">
            <a class="readmore" href="http://normanfinkelstein.com/books-2/">
              <button type="button" class="btn btn-default"> 
                More Books 
              </button>
            </a>
        ...
        <div class="col-md-6 ">
          <div class="row column-background">
            ...
            <?php endforeach ?>
            <div class="center col-md-12">
              <a class="readmore" href="http://normanfinkelstein.com/blog/">
                <button type="button" class="btn btn-default"> 
                  More New Postings 
                </button>
              </a>
        ...
        <div class="col-md-3">
          ...
          <div class="center col-md-12">
            <a class="readmore" href="http://normanfinkelstein.com/category/video/">
              <button type="button" class="btn btn-default"> 
                More Videos 
              </button>
            </a>
